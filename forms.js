function demoDisplay() {
    ...
    if (fName == null || fName == "", lName == null || lName == "", addRess == null || addRess == "", pinCode == null || pinCode == "") {
        ...
        firstRow.innerHTML = fName;
        secondRow.innerHTML = lName;
        thirdRow.innerHTML = addRess;
        fourthRow.innerHTML = pinCode;
        fifthRow.innerHTML = gender.value;

        if (f1.checked) {
            sixthRow.innerHTML = f1.value;
        }
        if (f2.checked) {
            sixthRow.innerHTML = f2.value;
        }
        if (f3.checked) {
            sixthRow.innerHTML = f3.value;
        }
        if (f4.checked) {
            sixthRow.innerHTML = f4.value;
        }
        if (f5.checked) {
            sixthRow.innerHTML = f5.value;
        }

        seventhRow.innerHTML = states.value;
        eigthRow.innerHTML = countrys.value;
